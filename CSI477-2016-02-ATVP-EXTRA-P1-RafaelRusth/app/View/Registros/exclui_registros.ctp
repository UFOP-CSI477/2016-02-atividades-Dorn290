<div class="form-top container top-content form-top row">
  <div class="row">
    ...
    <div>
      ...
      <div class="col-md-6">
        <p class="lead"><a><a>Você está na<a/><strong>   ÁREA DO ATLETA. </strong> <br/>Altere seu Registro:</p>
      </div>
          ...
          <div class="col-md-7 col-sm-offset-1">
            <div class="panel panel-primary">
              ...
              <div class="panel-body">
                ...
                <br/><center><a href="<?php echo Router::url(array('controller' => 'atletas', 'action' => 'geral')); ?>">Voltar</a></center>
                <br/>

            ...
            <div class="panel panel-primary">
              ...
              <div class="panel-body">
                <ul class="nav nav-pills nav-stacked">
                  <li role="presentation"  class="active"><a href="<?php echo Router::url(array('controller' => 'procedimentos', 'action' => 'index')); ?>">Área Geral</a></li>
    ...
    <div>
      ...
      <?php foreach ($procedimentos as $e): ?>
        ...
        <tr>
          ...
          <td>
            <?= $this->Html->link($e['Procedimento']['nome'], array('controller' =>'procedimentos', 'action' => 'view', $e['Procedimento']['id'])) ?>
          </td>

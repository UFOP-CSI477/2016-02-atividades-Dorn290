    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading">Criar Turma</div>
                <div class="panel-body">

                    <form class="form-horizontal" role="form" method="POST" enctype="multipart/form-data" action="/turmas">
                      {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('estado') ? ' has-error' : '' }}">
                            <label for="nome" class="col-md-4 control-label">Disciplina</label>
                            <div class="col-md-6">
